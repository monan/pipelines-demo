...
class EntityTypeInfo {
  ...
  public function entityExtraFieldInfo() {
    ...
    foreach ($this->getModeratedBundles() as $bundle) {
      $return[$bundle['entity']][$bundle['bundle']]['form']['fake_moderation_state'] = [
        'label' => $this->t('Moderation state'),
        'description' => $this->t('The moderation state of this piece of content.'),
        'weight' => -5,
      ];
