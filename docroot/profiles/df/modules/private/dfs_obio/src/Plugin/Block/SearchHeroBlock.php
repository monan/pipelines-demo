 ...
 * )
 */
class SearchHeroBlock extends SearchBlock implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $build['search_form_container']['form'] = \Drupal::formBuilder()->getForm('Drupal\search\Form\SearchBlockForm');
