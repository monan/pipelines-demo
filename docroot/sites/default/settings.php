...
// Oddly specific Dev Desktop fix for images being broken.
if (!isset($settings['file_public_path'])
  && isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'])
  && isset($_SERVER['SERVER_NAME'])
  && is_link(DRUPAL_ROOT . '/sites/' . $_SERVER['SERVER_NAME'])) {
  $settings['file_public_path'] = 'sites/' . $_SERVER['SERVER_NAME'] . '/files';
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_cddemo13_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_cddemo13_dev_default.inc';
}
// </DDSETTINGS>
